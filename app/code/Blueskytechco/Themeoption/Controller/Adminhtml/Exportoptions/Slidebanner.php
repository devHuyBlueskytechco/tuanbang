...
class Slidebanner extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
		...
		$content_name = $dom->createCDATASection('Umino - Clean minimal Magento 2 theme');
		...
		foreach ($stores as $store) {
    		...
    		$arr = ['title' => $store->getName(),'identifier' => $store->getCode(),'image' => 'blueskytechmage.com/preview/umino/'.$store->getCode().'.png','linkpreview' => 'umino.mageblueskytech.com/'.$store->getCode()];
